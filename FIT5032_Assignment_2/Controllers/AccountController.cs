    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (user != null)
                    {
                        // 使用 UserId 查询 AspNetUserRoles 表，获取角色信息
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Debug.WriteLine("UserRole value: " + model.UserRole); // 添加调试语句
                                                                      // 创建角色并将用户分配给角色
                ...
                if (result.Succeeded)
                {
                    ...
                    Debug.WriteLine("Redirecting to role: " + model.UserRole);
                    // 根据 UserRole 的值进行重定向
                    switch (model.UserRole)
                    {
                        case "Patient":
                            Debug.WriteLine("Redirecting to Patients/Create");
                        ...
                        // 如果 UserRole 不在已知的选项中，可以进行默认重定向
                        default:
                            return RedirectToAction("Index", "Home");
                    }
